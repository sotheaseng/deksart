    ...
    <div class="min-h-screen flex flex-col justify-center items-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <?php if(Route::has('login')): ?>
            <div style="position: absolute; top: 1rem; right: 1rem;">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary" style="margin-right: 0.5rem;">Log in</a>
        ...
        <div class="text-center" style="color: white;">
            ...
            <div class="flex justify-center" style="gap: 1rem;">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary" style="font-size: 1.125rem; padding: 0.75rem 1.5rem;">
                        Go to Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" style="font-size: 1.125rem; padding: 0.75rem 1.5rem;">
                        Get Started
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH /Users/sothea/Downloads/hotel-management-system (3)/resources/views/welcome.blade.php ENDPATH**/ ?>